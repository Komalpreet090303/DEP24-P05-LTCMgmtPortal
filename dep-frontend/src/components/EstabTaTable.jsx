    ...
    <>
      <ul>
        <li className="py-8 flex space-x-1 items-center">
          ...
          <span  className="whitespace-nowrap font-medium">{`${formDetail.user.firstName}  ${formDetail.user.lastName}`}</span>
        ...
        <li>
          ...
          <span  className="mx-2 whitespace-nowrap font-medium">{`${formDetail.user.firstName}  ${formDetail.user.lastName}`}</span>
          .
        </li>
      </ul>
    </>
